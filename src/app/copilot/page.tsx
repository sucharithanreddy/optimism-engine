        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-800">Coach Copilot</h1>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-blue-100 p-6 mb-6">
          ...
          <textarea
            ...
            className="w-full h-40 p-4 border border-blue-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-slate-700 placeholder:text-slate-400"
          />
          <div className="flex items-center justify-between mt-4">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-blue-500 to-teal-500 text-white rounded-xl font-medium hover:from-blue-600 hover:to-teal-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-all"
            >
              {isLoading ? (
                <>
            ...
            >
              ...
              >
                ...
                <SignInButton mode="modal">
                  <button className="w-full py-3 bg-gradient-to-r from-blue-500 to-teal-500 text-white rounded-xl font-medium hover:from-blue-600 hover:to-teal-600 transition-all">
                    Sign Up Free
                  </button>
                </SignInButton>
                <button
        ...
        <AnimatePresence>
          {analysis && (
            ...
            >
              ...
              {/* 3. WHAT TO EXPECT */}
              <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-2xl border border-blue-100 p-5">
